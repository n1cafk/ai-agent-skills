---
name: typescript-nextjs-cloudflare
description: Expert guidance for TypeScript, Node.js, Next.js App Router, React, Shadcn UI, Radix UI, Tailwind CSS, DrizzleORM, and Cloudflare developer tools (D1, KV, R2, AI). Use when developing full-stack applications with these technologies.
license: MIT
source: PatrickJS/awesome-cursorrules
---

# TypeScript + Next.js + Cloudflare Development
